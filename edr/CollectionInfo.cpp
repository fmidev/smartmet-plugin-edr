...
void CollectionInfoContainer::addVisibleCollections(SourceEngine theSource,
                                                    const std::set<std::string>& theCollections)
{
  itsVisibleCollections[theSource] = theCollections;
}

const CollectionInfo& CollectionInfoContainer::getInfo(SourceEngine theSource,
                                                       const std::string& theId) const
{
...
bool CollectionInfoContainer::isVisibleCollection(SourceEngine theSource,
                                                  const std::string& theCollectionName) const
{
  ...
  return (visible_collections.find(theCollectionName) != visible_collections.end() ||
          visible_collections.find("*") != visible_collections.end());
}
