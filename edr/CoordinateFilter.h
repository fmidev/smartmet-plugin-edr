...
public:
  ...
  void add(double longitude, double latitude, double level, const boost::posix_time::ptime& timestep);
  bool accept(double longitude, double latitude, double level, const boost::posix_time::ptime& timestep) const;
  bool isEmpty() const;
