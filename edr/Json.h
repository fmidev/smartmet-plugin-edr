...
enum class ValueType{stringValue,doubleValue,intValue,boolValue,nullValue,arrayValue,objectValue};
  ...
  public:
    ...
    DataValue(const NullValue& value)
	{
	  data = value;
	}
