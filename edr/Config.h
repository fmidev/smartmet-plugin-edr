...
class Config : private boost::noncopyable
{
 public:
  ...
  const std::vector<std::string> &timeSeriesUrls() const { return itsTimeSeriesUrls; }
 ...
 private:
  ...
  // URLs (canonicalized: leading '/', no trailing '/') at which timeseries-style
  // requests are also handled. Empty means no timeseries support.
  std::vector<std::string> itsTimeSeriesUrls;
